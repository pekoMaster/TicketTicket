  ...
  return (
    <div className="space-y-4 lg:space-y-6 w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 lg:hidden">活動管理</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-9 sm:pl-10 pr-4 py-2 sm:py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-sm"
            />
          </div>
          ...
          <select
            ...
            className="px-3 sm:px-4 py-2 sm:py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-sm"
          >
              ...
              >
                ...
                <div className="flex items-start justify-between gap-2 mb-3">
                  <div className="flex-1 min-w-0">
                    <h3 className="font-medium text-gray-900 dark:text-gray-100 truncate">{event.name}</h3>
                    <p className="text-sm text-gray-500 dark:text-gray-400 truncate">{event.artist}</p>
                  </div>
                  <span
                    className={`inline-flex px-2 py-0.5 text-xs font-medium rounded-full shrink-0 ${EVENT_CATEGORY_INFO[event.category].color
                      }`}
                  >
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
                  <button
                    ...
                    className={`inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium rounded-full transition-colors ${event.isActive
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                  <tr>
                    <th className="px-4 lg:px-6 py-3 lg:py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">
                      活動
                    </th>
                    <th className="px-4 lg:px-6 py-3 lg:py-4 text-left text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">
                      藝人
                    ...
                    <th className="px-4 lg:px-6 py-3 lg:py-4 text-right text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">
                      操作
                    </th>
                  </tr>
                </thead>
                  ...
                  {filteredEvents.map((event) => (
                    <tr key={event.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                      <td className="px-4 lg:px-6 py-4">
                        <p className="font-medium text-gray-900 dark:text-gray-100 truncate max-w-[200px] lg:max-w-[300px]">
                          {event.name}
                        </p>
                      </td>
                      <td className="px-4 lg:px-6 py-4">
                        <span className="text-sm text-gray-700 dark:text-gray-300 truncate max-w-[150px] lg:max-w-[200px] block">{event.artist}</span>
                      </td>
                      <td className="px-4 lg:px-6 py-4">
                      ...
                      <td className="px-4 lg:px-6 py-4">
                        <span
                          className={`inline-flex px-2.5 py-1 text-xs font-medium rounded-full whitespace-nowrap ${EVENT_CATEGORY_INFO[event.category].color
                            }`}
                        >
                          {EVENT_CATEGORY_INFO[event.category].label}
                        </span>
                      ...
                      <td className="px-4 lg:px-6 py-4">
                        <button
                          onClick={() => toggleActive(event.id, event.isActive)}
                          className={`inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium rounded-full transition-colors whitespace-nowrap ${event.isActive
